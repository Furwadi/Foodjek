...
public class FetchDataTask4 extends AsyncTask<String,Void,String> {
	
	private final FetchDataListener4 listener;
    private String msg;
     
    public FetchDataTask4(FetchDataListener4 listener) {
    ...
    protected void onPostExecute(String sJson) {
        ...
        try {
            ...
            // create apps list
            List<Application4> apps = new ArrayList<Application4>();
