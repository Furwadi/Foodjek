...
public class MapPeta extends Activity {

	EditText lokawal;
	TextView lat1,lon1;
	Button setlok;
	SharedPreferences sharedpreferences;
	public static final String DatPref="ealamattujuan";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_map_peta);
        ...
        setlok.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View v) {
        		...
        		if(lokawal.getText().toString().equals(""))
        		{
        		...
        		else
        		{
                	...
                	editor.putString(DatPref, lokawal.getText().toString());
                 	editor.putString("elat2", lat1.getText().toString());
                	editor.putString("elon2", lon1.getText().toString());
                	editor.commit();
    				Intent lokawala=new Intent(MapPeta.this,PemesananActivity.class);
    ...
    private void initilizeMap() {
        ...
        googleMap.setOnCameraChangeListener(new OnCameraChangeListener() {
            public void onCameraChange(CameraPosition arg0) {   
                ...
                lokawal.setText(getAddressFromLatLng(arg0.target)+"");
                lat1.setText(arg0.target.latitude+"");
                lon1.setText(arg0.target.longitude+"");
